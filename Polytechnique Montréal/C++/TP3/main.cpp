...
//     Question 1: Pourquoi a-t-on besoin de l’attribut type_ dans la classe membre? Que ce serait-il passé s’il n’existait pas ?
//
//     L'attribut type_ dans la classe membre nous permet de connaître le type d'un membre dans 
//     la liste de membre* dans la classe gestionnaire. Cela est utile lorsqu'on souhaite manipulé un membre[i] 
//     puisqu' il possède des attributs specifiques à son type de membre .Si nous n'en avions pas eu, nous n'aurions pas pu
//     différencier les membres que contient un gestionnaire.
//
//
//      2. Quelle est l’importance de l’utilisation d’un static_cast ?
//
//      Un static_cast est un mot réservé C++ qui permet, à la compilation, de convertir un object d'une classe parent vers une classe enfant, et vice-versa 
//		pour un pointeur, sans perte d'informations (upcasting et downcasting). Ainsi le static_cast nous permet d'avoir accès aux attributs ou aux méthodes type d'une classe parent / enfant 
//		ce qui est essentiel à notre programme. En effet, le gestionnaire inclut une liste de Membre* dont certains sont réguliers et 
//		d'autres premiums et un membre possède une liste de Billet* dont certains sont des FlightPass et d'autres sont des Billets Réguliers.
//
//
...
int main() {
	...
	*mr1 += c2;
	...
	//test 31-32 acheter coupons Membre Premium
	...
	*/
	...
	// Testss 35: Initialisation Regulier
	tests.push_back(g->getCoupons().size() == 0
		&& g->getMembres().size() == 0);

	// Tests 36 - 37: Ajouter membre
	...
	//Tests 44 : Acheter coupon Membre Premium
	...
	*alex -= g->getCoupons()[1];
	...
	// Tests  45 - 46: Assigner billet avec billet Regulier:
	...
	//test 47-48: Assigner billet avec flightPass
	...
	//test 49: Assigner billet avec membre Premium
